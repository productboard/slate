...
var debug$4 = browser$1('slate:change');
...
var Change = function () {
  ...
  createClass(Change, [{
    ...
    value: function setOperationFlag(key, value) {
      index(false, 'As of slate@0.41.0 the `change.setOperationFlag` method has been deprecated.');
    ...
    value: function getFlag(key) {
      ...
      index(false, 'As of slate@0.41.0 the `change.getFlag` method has been deprecated.');
    ...
    value: function unsetOperationFlag(key) {
      index(false, 'As of slate@0.41.0 the `change.unsetOperationFlag` method has been deprecated.');
    ...
    value: function withoutNormalization(fn) {
      index(false, 'As of slate@0.41.0 the `change.withoutNormalization` helper has been renamed to `change.withoutNormalizing`.');
...
var debug$5 = browser$1('slate:editor');
...
var Editor = function () {
  ...
  createClass(Editor, [{
    ...
    value: function command(_command) {
      ...
      debug$5('command', { command: _command, args: args });
    ...
    value: function event(handler, _event) {
      ...
      debug$5('event', { handler: handler, event: _event });
    ...
    value: function query(_query) {
      ...
      debug$5('query', { query: _query, args: args });
    ...
    value: function run(key) {
      ...
      Object.defineProperty(next, 'change', {
        get: function get$$1() {
          index$1(false, 'As of Slate 0.42.0, the `editor` is no longer passed as the third argument to event handlers. You can access it via `change.editor` instead.');
        }
      });
